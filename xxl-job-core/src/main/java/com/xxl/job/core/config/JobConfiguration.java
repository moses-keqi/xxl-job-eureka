...
public class JobConfiguration implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        new DiscoveryUtil(ApplicationContextHolder.getBean(LookupService.class));
        ...
        logPath = StringUtils.isEmpty(logpath) ? "/data/applogs/xxl-job/jobhandler" : logpath;
        logRetentionDays = StringUtils.isEmpty(logretentiondays) ? -1 : Integer.parseInt(logretentiondays);
    }
}
